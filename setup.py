...
if (growbox_boot == 0):
	job = cron.new(command="python3 /home/pi/bin/growbox/growbox_boot.py >> /var/log/growbox.log 2>&1", comment="growbox_boot")
	job.every_reboot()
	cron.write()
	
if (growbox_run == 0):
	job = cron.new(command="python3 /home/pi/bin/growbox/growbox_run_handler.py >> /var/log/growbox.log 2>&1", comment="growbox_run")
	job.minute.every(1)
	cron.write()
